...
<head>
    ...
    <script>
        function initialiser() {
            ...
            $("#log").val("<?php echo $_SESSION['login'] ?>");
        }
    </script>
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation5" data-menu="menu-navigation" class="navigation navigation-main">
                        <li class="nav-item">
                            <a href="accueilenseignant.php"><i class="ft-home"></i><span data-i18n="" class="menu-title">Tableau de bord</span></a>
                        </li>
                        <?php
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            <form class="form" method="post" action="modificationprofileenseignant.php" id="ff">
                                            <input type="hidden" id="niveau" class="form-control" value="<?php echo $_GET['niveau'] ?>" name="niveau">
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Login</label>
                                                                <input required pattern="[a-zA-Z ]{3,20}" type="text" id="log" class="form-control" value="<?php echo $_SESSION['login'] ?>" name="login">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Mot de passe</label>
                                                                <input required type="text" pattern="[a-zA-Z0-9 ]{3,20}" id="mdp" class="form-control" value="<?php echo $_SESSION['mdp'] ?>" name="mdp">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
