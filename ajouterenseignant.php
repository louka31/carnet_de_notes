...
<?php
  ...
  include("config.php");
      ...
      if (isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['login'])  ){
        $requete = $db->prepare(' INSERT INTO enseignant (nom,prenom,genre,login,id_ecole)
          VALUES(:nom,:prenom,:genre,:login,:id_ecole)');
          ...
          echo "<script type='text/javascript'>
            document.addEventListener('DOMContentLoaded', function(event) {
                swal({
                  position: 'top-end',
                  icon: 'success',
                  title: 'Enseignant(e) a été bien enregistré(e)', 
                })
            });
            </script>";
		}
...
<section id="basic-form-layouts">
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header">Ajouter un nouveau enseignant</div>
    </div>
  </div>
    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-content">
          <div class="px-3">
            <form class="form"  method="post" action="ajouterenseignant.php" name="f">
              <div class="form-body">

                <div class="form-group">
                  <label for="eventRegInput1">Nom</label>
                  <input type="text" id="eventRegInput1" class="form-control" name="nom" required>
                </div>

                <div class="form-group">
                  <label for="eventRegInput2">Prenom</label>
                  <input type="text" id="eventRegInput2" class="form-control" name="prenom" required>
                </div>

                 <div class="form-group">
                                  <label for="userinput4">Genre</label>
                                  <br>
                ...
                <div class="form-group">
                  <label for="eventRegInput5">Login</label>
                  <input number id="eventRegInput5" class="form-control" name="login" required >
                </div>
