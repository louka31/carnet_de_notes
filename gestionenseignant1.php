...
swal({
  title: "Etes-vous sûre de activer ce compte?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
.then((willDelete) => {
  if (willDelete) {
    ...
    $.ajax({  
         url:        'http://localhost/carnetdenotes/suppressionenseignant.php' ,  
         type:       'POST',
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
						...
						<li class=" nav-item active"><a href="gestionenseignant1.php"><i class="ft-user-x"></i><span data-i18n="" class="menu-title">Comptes désactivés</span></a>
                        </li>
...
<div class="row">
  <div class="col-12">
    <div class="content-header">Comptes désactivés</div>
  ...
  <div class="row">
	...
	$db = new PDO("mysql:host=$host;dbname=$data", "$user", "$pass");}
	     ...
	     die('Erreur : ' . $e->getMessage());}
			  $requete=$db->prepare('Select * from enseignant where id_ecole= :y and active =0');
		...
		'y'=> $_SESSION['id_ecole'] 
              ...
              <thead><tr><th>#</th><th>Nom</th><th>Prenom</th><th>Genre</th><th>Login</th><th>Activation</th></tr></thead><tbody>";
				  while($reponse=$requete->fetch()){ 
				   			  
					  echo"<tr><td>".$i."</td><td>".$reponse['nom']."</td><td>".$reponse['prenom']."</td><td>".$reponse['genre']."</td><td>".$reponse['login']."</td>
                    
                    
                  "."<td>
                    
                    <a onclick=\"supprimer(". $reponse['id_enseignant'] .");return false;\" class=\"success p-0\" data-original-title=\"\" title=\"\">
                      <button type=\"button\" class=\"btn btn-raised btn-outline-info round btn-min-width mr-1 mb-1\">Activer</button>
                    </a>";
				   $i++;
				  }
             echo"
