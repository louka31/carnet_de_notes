...
<?php
  ...
  include("config.php");
      ...
      if (isset($_POST['id_mat']) && isset($_POST['id_niv'])  && isset($_POST['id_clas'])){
        $requete = $db->prepare(' INSERT INTO affectation (id_enseignant,id_classe,id_matiere,anneescolaire)
          VALUES(:id_enseignant,:id_classe,:id_matiere,:annee)');
        $requete->execute(array(
          'id_enseignant' => $_POST['x'],
          'id_classe' => $_POST['id_clas'],
          'id_matiere' => $_POST['id_mat'],
			          'annee' => $_POST['annee']

        ));
		 header("Location: affecter1.php?idd=".$_POST['x']);
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                        ...
                        <li class=" nav-item active"><a href="gestionenseignant.php"><i class="ft-user-check"></i><span data-i18n="" class="menu-title">Comptes activés</span></a>
                        </li>
...
$requetee=$dbb->prepare('select nom ,prenom  from enseignant where id_enseignant= :t ');
			  $requetee->execute(array('t'=> $_GET['iddd']));
$rep=$requetee->fetch();
		  ?>
      <div class="content-header">Ajouter une nouvelle affectation à <?php echo $rep['prenom'] , $rep['nom'] ; ?> </div>
    </div>
  </div>
    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-content">
          <div class="px-3">
            <form class="form"  method="post" action="ajouteraffectation.php" name="f">
              <div class="form-body">
                  ...
                  <label for="userinput6">Niveau</label>
                              <div>
<?php
         include("config.php");
      ...
      try {
        ...
        die('Erreur : ' . $e->getMessage());
			  ...
			  $reponsee=$db->query('Select * from niveau ');
				 
				echo"<select required id=\"id_niv\"   name=\"id_niv\"  class=\"custom-select cz-sidebar-width float-right \"> <option> -----------</option>";
				  while($entre=$reponsee->fetch())
				  { 
					  echo"<option value=".$entre['id_niveau'].">".$entre['nom_niveau']."</option>";
				  }
             echo"</select>";
			  ...
			  ?>
				  ...
				  <div class="form-group">
                  <label for="userinput6">Classe</label>
                              <div><select id="id_clas" name="id_clas" class="custom-select cz-sidebar-width float-right " >
				 <option value="">-------</option></select>
				  ...
				  <div class="form-group">
                  <label for="userinput6">Matiere</label>
                              <div>

<select id="id_mat" name="id_mat" class="custom-select cz-sidebar-width float-right ">
				  <option value="">-------</option></select>
			  ...
			  $ann=(int)$an;
				...
				?>
<div class="form-group">
                  <input type="hidden"  id="annee" class="form-control" name="annee" value="<?php echo $g ?>">
                </div>
				
				
				
				<div class="form-group">
                  <input type="hidden"  id="x" class="form-control" name="x" value="<?php echo $_GET['iddd'] ?>">
                </div> 
              ...
              <div class="form-actions center">
                <input type="reset" class="btn btn-raised btn-warning mr-1" value="Annuler">
                            ...
                            <input type="submit" class="btn btn-raised btn-primary" value="Enregistrer">
              </div>
            </form>
          </div>
        </div>
