...
<html lang="en" class="loading">
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.1/sweetalert.min.js"></script>
    ...
    function supprimer(id_enseignant){

swal({
  title: "Etes-vous sûre de supprimer cette matiere?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
.then((willDelete) => {
  if (willDelete) {
    ...
    $.ajax({  
         url:        'http://localhost/carnetdenotes/suppressionmatiere.php' ,  
         type:       'POST',
         data: {idadmin: id_enseignant},                 
         async:      true,  
         success: function(status) {  
           
              swal("L enseignant est supprimée", {
                icon: "success",
               }).then((value) => {
    ...
    swal("La demande n'est pas supprimée");
  }
});
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                        ...
                        <li class=" nav-item active"><a href="gestionmatieres.php"><i class=" ft-edit"></i><span data-i18n="" class="menu-title">Gestion matieres</span></a>
                        </li>
...
<div class="row">
  <div class="col-12">
    <div class="content-header">1ere année</div>
    <a style="margin-left: 78%;" href="ajoutermatiere.php"><button type="button"
													class="btn btn-raised btn-success btn-min-width mr-1 mb-1">
													<i class="ft-plus"></i> Ajouter une matiere
												</button></a>
  </div>
</div>
<section id="extended">
      ...
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body table-responsive">
			  ...
			  <?php
             include("config.php");
			    if (isset($_SESSION['id_ecole'])){
			  try {
	$db = new PDO("mysql:host=$host;dbname=$data", "$user", "$pass");}
	catch (Exception $e) {
	     die('Erreur : ' . $e->getMessage());}
			  $reponse=$db->prepare('Select * from matiere where id_niveau=:e and id_ecole= :y ');
			  
			  $reponse->execute(array( 'e'=> 1 , 'y'=> $_SESSION['id_ecole']));	
              ...
              <thead><tr><th>#</th><th>Libelle</th><th>Coefficient</th><th>Actions</th></tr></thead><tbody>";
				  while($entree=$reponse->fetch())
				  { 
	
					  echo"<tr><td>".$i."</td><td>".$entree['libelle']."</td><td>".$entree['coefficient']."</td><td>
                    
                    <a href='modifiermatiere.php?id=$entree[id_matiere]'  class=\"success p-0\" data-original-title=\"\" title=\"\">
                      <i class=\"ft-edit-2 font-medium-3 mr-2\"></i>
                    </a>
                    <a href=\"#\" onclick=\"supprimer(". $entree['id_matiere'] .");return false;\" class=\"danger p-0\" data-original-title=\"\" title=\"\">
...
<!--Shopping cart starts-->
			  ...
			  <div class="row">
  <div class="col-12">
    <div class="content-header">2eme année</div>
    <a style="margin-left: 78%;" href="ajoutermatiere.php"><button type="button"
													class="btn btn-raised btn-success btn-min-width mr-1 mb-1">
													<i class="ft-plus"></i> Ajouter une matiere
												</button></a>
  ...
  <div class="row">
	...
	$db = new PDO("mysql:host=$host;dbname=$data", "$user", "$pass");}
	     ...
	     die('Erreur : ' . $e->getMessage());}
			  ...
			  $reponse->execute(array( 'e'=> 2 , 'y'=> $_SESSION['id_ecole'] ));	
             ...
             echo"
			  ...
			  <div class="row">
  <div class="col-12">
    <div class="content-header">3eme année</div>
    <a style="margin-left: 78%;" href="ajoutermatiere.php"><button type="button"
													class="btn btn-raised btn-success btn-min-width mr-1 mb-1">
													<i class="ft-plus"></i> Ajouter une matiere
												</button></a>
  ...
  <div class="row">
	...
	$db = new PDO("mysql:host=$host;dbname=$data", "$user", "$pass");}
	     ...
	     die('Erreur : ' . $e->getMessage());}
			  ...
			  $reponse->execute(array( 'e'=> 3 , 'y'=> $_SESSION['id_ecole']));	
		...
		<div class="row">
  <div class="col-12">
    <div class="content-header">4eme année</div>
    <a style="margin-left: 78%;" href="ajoutermatiere.php"><button type="button"
													class="btn btn-raised btn-success btn-min-width mr-1 mb-1">
													<i class="ft-plus"></i> Ajouter une matiere
												</button></a>
  ...
  <div class="row">
	...
	$db = new PDO("mysql:host=$host;dbname=$data", "$user", "$pass");}
	     ...
	     die('Erreur : ' . $e->getMessage());}
			  ...
			  $reponse->execute(array( 'e'=> 4 , 'y'=> $_SESSION['id_ecole']));	
             ...
             echo"</tr>
			  ...
			  <div class="row">
  <div class="col-12">
    <div class="content-header">5eme année</div>
    <a style="margin-left: 78%;" href="ajoutermatiere.php"><button type="button"
													class="btn btn-raised btn-success btn-min-width mr-1 mb-1">
													<i class="ft-plus"></i> Ajouter une matiere
												</button></a>
  ...
  <div class="row">
	...
	$db = new PDO("mysql:host=$host;dbname=$data", "$user", "$pass");}
	     ...
	     die('Erreur : ' . $e->getMessage());}
			  ...
			  $reponse->execute(array( 'e'=> 5 , 'y'=> $_SESSION['id_ecole']));	
             ...
             echo"</tr>
			  ...
			  <div class="row">
  <div class="col-12">
    <div class="content-header">6eme année</div>
    <a style="margin-left: 78%;" href="ajoutermatiere.php"><button type="button"
													class="btn btn-raised btn-success btn-min-width mr-1 mb-1">
													<i class="ft-plus"></i> Ajouter une matiere
												</button></a>
  ...
  <div class="row">
	...
	$db = new PDO("mysql:host=$host;dbname=$data", "$user", "$pass");}
	     ...
	     die('Erreur : ' . $e->getMessage());}
			  ...
			  $reponse->execute(array( 'e'=> 6 , 'y'=> $_SESSION['id_ecole']));	
