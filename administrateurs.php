...
swal({
  title: "Etes-vous sûre de supprimer cet administrateur?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
  ...
  if (willDelete) {
    ...
    $.ajax({  
         ...
         success: function(status) {  
              ...
              swal("L'administrateur est supprimé", {
                icon: "success",
               }).then((value) => {
    ...
    swal("L'administrateur n'est pas supprimée");
  }
});
                  ...
                  <div class="card-content">
                    <div class="card-body card-dashboard table-responsive">
                      ...
                      if (!$reponse) {
                        ...
                        echo "<table class=\"table table-striped table-bordered zero-configuration\"><thead><tr><th>Nom</th><th>Prenom</th><th>Genre</th><th>Email</th><th>Ecole</th><th>Gouvernorat</th><th>Délégation</th><th>Suppression</th></tr></thead><tbody>";
