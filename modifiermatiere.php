...
<section id="basic-form-layouts">
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header">Modifier une  matiere</div>
    </div>
  </div>
  ...
  <div class="row justify-content-md-center">
	...
	$db = new PDO("mysql:host=$host;dbname=$data", "$user", "$pass");}
	     ...
	     die('Erreur : ' . $e->getMessage());}
			  $reponse=$db->prepare('Select * from matiere where id_matiere= :x ');
			  
			  $reponse->execute(array( 'x'=> $_GET['id']));	
			  
				 $entree=$reponse->fetch();
					  ?>
            <form class="form"  method="post" action="modificationmatiere.php" name="f">
              <div class="form-body">

                <div class="form-group">
                  <label for="eventRegInput1">Libelle</label>
                  <input type="text" id="libelle" class="form-control" name="libelle" required value=<?php echo $entree['libelle']?> >
                </div>

                <div class="form-group">
                  <label for="eventRegInput2">Coefficient</label>
                  <input type="text" pattern="[0-9].[0-9]{1}" id="coefficient" class="form-control" name="coefficient" required value=<?php echo $entree['coefficient']?> >
                </div>

                

               <input id="id_matiere" name="id_matiere" type="hidden" value=<?php echo $entree['id_matiere']?>>
