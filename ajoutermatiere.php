...
<?php
  ...
  include("config.php");
      ...
      if (isset($_POST['libelle']) && isset($_POST['coefficient']) && isset($_POST['id_niveau']) && isset($_SESSION['id_ecole']) ){
        $requete = $db->prepare(' INSERT INTO matiere (libelle,coefficient,id_niveau,id_ecole)
          VALUES(:nom_matiere,:coefficient,:id_niveau,:id_ecole)');
        if ($requete->execute(array(
          'nom_matiere' => $_POST['libelle'],
          ...
          echo "<script type='text/javascript'>
            document.addEventListener('DOMContentLoaded', function(event) {
                swal({
                  position: 'top-end',
                  icon: 'success',
                  title: 'Matiere a été bien enregistré(e)', 
                })
            });
            </script>";
		}
...
<section id="basic-form-layouts">
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header">Ajouter une nouvelle matiere</div>
    </div>
  </div>
    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-content">
          <div class="px-3">
            <form class="form"  method="post" action="ajoutermatiere.php" name="f">
              <div class="form-body">

                <div class="form-group">
                  <label for="eventRegInput1">Libelle</label>
                  <input type="text" id="libelle" class="form-control" name="libelle" required>
                </div>

                <div class="form-group">
                  <label for="eventRegInput2">Coefficient</label>
                  <input type="text" pattern="[0-9].[0-9]{1}" id="coefficient" class="form-control" name="coefficient" required>
                </div>
